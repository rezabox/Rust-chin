...
function CardTitle2(){
  return(
    <div className="card_title2 px-4">
      <div className="title_header2 flex align-center justify-between p-4">
          <div className="title_right flex">
              <span className="title_right icon">
                  <img src={logo_svg} className='bg-slate-200 p-4 rounded-md' alt="logo_card2" />
              </span>
          ...
          <div className='header_dropdown mt-3 '>
             <div className="dropdown_select cursor-pointer text-base flex align-center bg-slate-200 p-3 mt-[-10px] text-color-sub-title rounded">
               <i className="bi bi-grid-3x3-gap-fill hidden md:block"></i>
               <div className='dropdown_select_content flex'>
                  <span className='dropdown_select_content_text mr-2 hidden md:block'>جدیدترین ها</span>
                  <span className='dropdown_select_content_arrow mr-0 md:mr-20'>
